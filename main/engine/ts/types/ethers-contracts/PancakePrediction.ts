...
export declare namespace PancakePredictionV2 {
...
export interface PancakePredictionInterface extends utils.Interface {
  functions: {
...
export interface NewOracleUpdateAllowanceEventObject {
  oracleUpdateAllowance: BigNumber;
}
export type NewOracleUpdateAllowanceEvent = TypedEvent<
  [BigNumber],
  NewOracleUpdateAllowanceEventObject
>;
...
export interface PancakePrediction extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PancakePredictionInterface;
  ...
  functions: {
    ...
    getUserRounds(
      ...
      [BigNumber[], PancakePredictionV2.BetInfoStructOutput[], BigNumber]
    >;
    ...
    setBufferAndIntervalSeconds(
      _bufferSeconds: PromiseOrValue<BigNumberish>,
      _intervalSeconds: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setOracleUpdateAllowance(
      _oracleUpdateAllowance: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    Pause(epoch?: PromiseOrValue<BigNumberish> | null): PauseEventFilter;
    ...
    Unpause(epoch?: PromiseOrValue<BigNumberish> | null): UnpauseEventFilter;
