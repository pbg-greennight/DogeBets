...
export function formatTime(timestamp: number): string {
  ...
  // Note the two spaces between date and time to match your example
...
export const getRoundData = async (epoch: BigNumber) => {
  ...
  const nextEpochTime = moment
  .unix(Number(lockTimestamp))
  .tz("America/New_York")
  ...
  return {
    ...
    previousRound, RoundLockPrice, RoundClosePrice, priceDifference,
  };
};
