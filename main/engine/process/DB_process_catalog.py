...
class FeatureCatalog:
    ...
    def ensure_calc(self, *, decision_dt, close_series=None) -> Dict[str, Any]:
        ...
        try:
            ...
            from main.engine.process.DB_process_calc import build_calc_out
        ...
        *,
        ...
        if ws is None and model_path:
            try:
                ...
                from main.engine.process.DB_process_calc import load_model_config
        ...
        def _nb_like(c: "FeatureCatalog") -> float:
            try:
                try:
                    ...
                    from main.engine.process.DB_process_gauss_channel import build_gauss_channel_snapshot
